...
{
    public class AbstractBaseViewModel : DisposableObject, IViewModel
    {
        ...
        private sealed class SuspendedNotifications : IDisposable
        {
            ...
            private readonly AbstractBaseViewModel _target;

            public SuspendedNotifications(AbstractBaseViewModel target)
            {
                _target = target;
